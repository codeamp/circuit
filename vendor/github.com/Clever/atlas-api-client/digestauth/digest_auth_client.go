// package digest_auth_client is forked from github.com/xinsnake/go-http-digest-auth-client
// modifications:
// - added a "Header" field to DigestRequest so that headers like Content-Type are maintained throughout the digest auth handshake
package digestauth
