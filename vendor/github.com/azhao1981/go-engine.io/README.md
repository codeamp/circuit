...
[![GoDoc](http://godoc.org/github.com/azhao1981/go-engine.io?status.svg)](http://godoc.org/github.com/azhao1981/go-engine.io) [![Build Status](https://travis-ci.org/googollee/go-engine.io.svg)](https://travis-ci.org/googollee/go-engine.io)
...
```bash
go get github.com/azhao1981/go-engine.io
```

Import it with:

```go
import "github.com/azhao1981/go-engine.io"
```
