...
func pluginsCodeampGraphqlSchemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/codeamp/graphql/schema.graphql", size: 9320, mode: os.FileMode(420), modTime: time.Unix(1547579190, 0)}
