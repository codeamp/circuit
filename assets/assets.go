...
func pluginsCodeampGraphqlSchemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/codeamp/graphql/schema.graphql", size: 9307, mode: os.FileMode(420), modTime: time.Unix(1541698161, 0)}
