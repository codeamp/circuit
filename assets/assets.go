...
func pluginsCodeampGraphqlSchemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/codeamp/graphql/schema.graphql", size: 9180, mode: os.FileMode(420), modTime: time.Unix(1532589919, 0)}
