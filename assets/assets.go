...
func pluginsCodeampGraphqlSchemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/codeamp/graphql/schema.graphql", size: 10385, mode: os.FileMode(420), modTime: time.Unix(1566597869, 0)}
