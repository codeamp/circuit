...
func pluginsCodeampGraphqlSchemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/codeamp/graphql/schema.graphql", size: 9301, mode: os.FileMode(436), modTime: time.Unix(1547329374, 0)}
...
func pluginsCodeampGraphqlStaticIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/codeamp/graphql/static/index.html", size: 2810, mode: os.FileMode(436), modTime: time.Unix(1529555449, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
