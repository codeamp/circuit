...
func pluginsCodeampSchemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "plugins/codeamp/schema.graphql", size: 7449, mode: os.FileMode(420), modTime: time.Unix(1525371884, 0)}
