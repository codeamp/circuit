...
func (x *Kubernetes) sendDDResponse(e transistor.Event, services []plugins.Service, state plugins.State, failureMessage string) {
...
func (x *Kubernetes) sendDDSuccessResponse(e transistor.Event, services []plugins.Service) {
	x.sendDDResponse(e, services, plugins.Complete, "")
}

func (x *Kubernetes) sendDDErrorResponse(e transistor.Event, services []plugins.Service, failureMessage string) {
	x.sendDDResponse(e, services, plugins.Failed, failureMessage)
}

func (x *Kubernetes) sendDDInProgress(e transistor.Event, services []plugins.Service, message string) {
...
func (x *Kubernetes) createDockerIOSecretIfNotExists(namespace string, coreInterface corev1.CoreV1Interface) error {
