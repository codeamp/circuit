...
// func (suite *TestSuiteScheduledBranchReleaserExtension) TestCreateSBRExtSuccess() {
// 	event := transistor.NewEvent(plugins.GetEventName("project:scheduledbranchreleaser"), transistor.GetAction("create"), nil)
...
// 	var err error
// 	for {
// 		e, err = suite.transistor.GetTestEvent("project:scheduledbranchreleaser", transistor.GetAction("status"), 30)
// 		if err != nil {
...
// func (suite *TestSuiteScheduledBranchReleaserExtension) TestUpdateSBRExtSuccess() {
// 	event := transistor.NewEvent(plugins.GetEventName("project:scheduledbranchreleaser"), transistor.GetAction("update"), nil)
// 	// event.Artifacts = suite.buildMongoExtArtifacts()
// 	suite.transistor.Events <- event
...
// func (suite *TestSuiteScheduledBranchReleaserExtension) TestDeleteSBRExtSuccess() {
// 	event := transistor.NewEvent(plugins.GetEventName("project:scheduledbranchreleaser"), transistor.GetAction("delete"), nil)
// 	// event.Artifacts = suite.buildMongoExtArtifacts()
// 	suite.transistor.Events <- event
